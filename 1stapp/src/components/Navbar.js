...
//       <Link className="navbar-brand fs-1 fst-italic fw-bold" to="/">Zowiggy</Link>
...
//             <Link className="btn bg-white text-warning mx-1"  to="/userdata">Signup</Link>
//             </div>
//              : <div>
//               <div className='btn bg-white text-warning mx-3' onClick={()=>{setsetview(true)}}>
//              My Cart{" "}
//              <Badge pill bg="danger">{data.length}</Badge>
//             </div>  
//             {setview ? <Modal onClose={()=>{setsetview(false)}}> <Cart/></Modal>:null}

//              <div className='btn bg-white text-danger mx-3 ' onClick={logout}>
// Logout</div>   
// </div> 
//          }
